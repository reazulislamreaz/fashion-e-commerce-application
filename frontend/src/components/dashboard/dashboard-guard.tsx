    ...
    return (
      <div className="flex min-h-screen w-full flex-col items-center justify-center bg-stone-100 p-6 text-stone-900">
        <div className="w-full max-w-md rounded-3xl border border-stone-200 bg-white p-8 shadow-xl text-center">
          <div className="mx-auto flex size-16 items-center justify-center rounded-2xl bg-rose-50 text-rose-600 shadow-xs mb-4">
          ...
          <h1 className="mt-3 text-2xl font-extrabold text-stone-950 font-display">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <Link
              ...
              className="w-full rounded-xl border border-stone-300 bg-white py-3 text-xs font-bold text-stone-700 hover:bg-stone-50 transition-colors"
            >
