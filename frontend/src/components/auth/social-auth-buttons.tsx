    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl border border-stone-300 bg-white py-2.5 px-4 text-xs font-semibold text-stone-700 shadow-2xs hover:bg-stone-50 hover:border-stone-400 transition-all"
        >
