...
export default function DashboardOrdersPage() {
  ...
  const fetchOrdersList = useCallback(async () => {
    ...
    try {
      ...
      const orderList = Array.isArray(res) ? res : res?.items || [];
  ...
  return (
    <DashboardShell allowedRoles={['SUPER_ADMIN', 'ADMIN', 'MANAGER']}>
      <div className="flex flex-col gap-6">
        ...
        {/* Filter Toolbar */}
        <div className="flex items-center justify-between border border-stone-200 bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="border border-stone-200 bg-stone-50 py-2 px-3 text-xs font-medium text-stone-900 focus:border-[#C9A227] focus:bg-white focus:outline-none"
            >
                      ...
                      <tr key={ord.id} className="hover:bg-stone-50/80 transition-colors">
                        ...
                        <td className="py-3.5 px-4">
                          <select
                            ...
                            className="border border-stone-200 bg-stone-50 py-1 px-2 text-[11px] font-bold text-stone-800 focus:border-[#C9A227] focus:outline-none disabled:opacity-50"
                          >
                        ...
                        <td className="py-3.5 px-4 text-right">
                          <Link
                            ...
                            className="inline-flex items-center gap-1 border border-stone-200 bg-white px-2.5 py-1 text-xs font-bold text-stone-700 hover:bg-stone-50 transition-colors"
                          >
