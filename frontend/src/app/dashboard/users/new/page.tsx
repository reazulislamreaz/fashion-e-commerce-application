        ...
        >
          ...
          <div>
            ...
            <select
              ...
              className="w-full border border-stone-300 p-3 text-xs font-bold uppercase tracking-wider text-stone-900 focus:border-[#C9A227] focus:outline-none bg-white"
            >
              {ROLE_OPTIONS.map((r) => (
