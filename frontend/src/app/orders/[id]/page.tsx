  ...
  if (error || !order) {
    return (
      <div className="mx-auto w-full max-w-4xl px-4 py-16 text-center sm:px-6">
        ...
        <Link
          href="/orders"
          className="mt-6 inline-flex items-center gap-2 bg-stone-950 px-6 py-3 text-xs font-bold uppercase tracking-wider text-white"
        >
          View All Orders
        </Link>
      </div>
  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="border border-stone-200 bg-white p-6 sm:p-8">
        ...
        {/* Shipping details */}
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6 bg-stone-50 p-4 border border-stone-200">
          <div>
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-col divide-y divide-stone-100 border border-stone-200 overflow-hidden">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex size-10 items-center justify-center bg-stone-100 text-stone-400">
        ...
        <div className="mt-8 flex justify-end">
          <Link
            href="/products"
            className="inline-flex items-center gap-2 bg-stone-950 px-6 py-3 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#C9A227] hover:text-stone-950 transition-colors"
          >
