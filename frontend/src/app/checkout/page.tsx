...
export default function CheckoutPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-extrabold text-stone-950 font-display border-b border-stone-200 pb-4">
        Checkout
      </h1>
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          {!isAuthenticated && (
            <div className="rounded-2xl border border-amber-400/40 bg-amber-400/5 p-4 flex items-center justify-between">
              <div>
                <p className="text-xs font-bold text-stone-900">Have an account?</p>
              ...
              <Link
                ...
                className="rounded-lg bg-stone-950 px-4 py-2 text-xs font-bold text-white hover:bg-[#C9A227] hover:text-stone-950 transition-colors"
              >
                Sign In
              </Link>
            </div>
          ...
          <form
            ...
            className="flex flex-col gap-6 rounded-2xl border border-stone-200 bg-white p-6 shadow-xs"
          >
            <h2 className="text-lg font-bold text-stone-950 font-display border-b border-stone-100 pb-3">
            ...
            <div className="pt-4 border-t border-stone-100">
              <button
                type="submit"
                disabled={submitting}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-stone-950 py-4 text-sm font-bold text-white shadow-lg hover:bg-[#C9A227] hover:text-stone-950 transition-colors disabled:opacity-50"
              >
                {submitting ? (
        ...
        {/* Order Items Preview */}
        <div className="h-fit rounded-2xl border border-stone-200 bg-white p-6 shadow-md flex flex-col gap-4">
          <h2 className="text-lg font-bold text-stone-950 font-display border-b border-stone-100 pb-3">
            Order Review
          </h2>
